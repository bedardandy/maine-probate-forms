---
form_id: PP-409
form_title: Petition to Resolve Disputed Claim and Petition for Allowance
...
|---|---|---|
| `attorney_signature` | 11..11 | rule |

## Known LLM failure modes (May-2026 eval)

| field | tier | eval signals |
|---|---|---|
| `petitioner_name_address_email` | green | miscompr 1/5 |
| `judge_signature` | green | oc 1/5 |
