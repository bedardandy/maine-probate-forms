---
form_id: PP-601
form_title: Petition for Other Protective Arrangements
...
| category | n | path |
|---|---|---|
| narrative_derived | 12 | LLM over narrative + validators |
...
|---|---|---|
| `petition_type` | orange | wrong 1/5; oc 1/5; miscompr 1/5 |
| `respondent_info` | green | oc 1/5 |
| `less_restrictive_alternatives` | yellow | oc 1/5; miscompr 1/5 |
